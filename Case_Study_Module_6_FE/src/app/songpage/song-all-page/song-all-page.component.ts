...
@Component({
  selector: 'app-song-all-page',
  templateUrl: './song-all-page.component.html',
  styleUrls: ['./song-all-page.component.css']
})
export class SongAllPageComponent implements OnInit {
