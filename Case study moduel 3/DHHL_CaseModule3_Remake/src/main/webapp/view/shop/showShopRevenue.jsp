    ...
    <div id="header">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- SEARCH BAR -->
                <div class="col-md-4">
                    <a href="/create-product?productid=${product.getProductID()}&shopid=${shop.getShopID()}"><input
                            type="submit" class="btn btn-primary btn-lg" style="background-color: red"
...
<div class="container">
    ...
    <table class="table table-striped">
        ...
        <tr>
            <td colspan="5" style="text-align: center; font-weight: bold">SUM</td>
            <c:set var="sum" value="${0}"/>
                <c:forEach items="${purchases}" var="purchase">
                    <c:set var="sum" value="${sum + purchase.getPurchaseQuantity() * purchase.getProductPrice()}"/>
                </c:forEach>
