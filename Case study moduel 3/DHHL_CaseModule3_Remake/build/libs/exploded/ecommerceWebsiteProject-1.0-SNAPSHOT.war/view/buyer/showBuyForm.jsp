    ...
    <div class="card">
        <div class="container-fliud">
            <div class="wrapper row">
                ...
                <form action="/buy-product?productid=${product.getProductID()}&buyerid=${buyer.getUserID()}" method="post">
                <div class="details col-md-6">
                    ...
                    <h5 class="sizes" style="width: 300px">shop name:
                    ...
                    <h5 class="colors" style="width: 300px;"> Available Quantity:
                        <span>${product.getProductQuantity()}</span>
                    </h5>
                    <h5>
                        <input type="text" name="quantity" placeholder="Enter quantity to buy">
                    </h5>
                    <h5>
