    ...
    <div class="card">
        <div class="container-fliud">
            <div class="wrapper row">
                ...
                <form action="/show-edit-form?productid=${product.getProductID()}&shopid=${shop.getShopID()}"
                      method="post">

                    <div class="details col-md-6">
                        <input type="text" name="productid" hidden>
                        <input type="text" name="shopid" hidden>
                        <h3 class="product-title">Name:<input type="text" name="productName"
                                                              value="${product.getProductName()}"></h3>

                        <p class="product-description">Description:<input type="text" name="productDescription"
                                                                          value="${product.getProductDescription()}">
                        </p>
                        <h4 class="price">Price: <input type="text" name="productPrice"
                                                        value="${product.getProductPrice()}"></h4>

                        <h5 class="colors" style="width: 300px;"> Available Quantity:
                            <input type="text" name="productQuantity" value="${product.getProductQuantity()}">
                        </h5>
