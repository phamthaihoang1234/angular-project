...
import {SongService} from '../../serviceShop/song/song.service';
import {SingerService} from '../../serviceShop/singer/singer.service';
...
export class CreatesongComponent implements OnInit {
  ...
  cancel(){
    this.route.navigate(['/listshopproduct/' + this.currentUser.username]);
  }
